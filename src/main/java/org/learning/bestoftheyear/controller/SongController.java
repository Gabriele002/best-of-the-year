...
public class SongController {
  ...
  private List<Song> getSongs() {
    ...
    songList.add(new Song(1, "Without me","Eminem"));
    songList.add(new Song(2, "SICK MODE","Travis scoot"));
    songList.add(new Song(3, "Wow.","Post Malone"));
    songList.add(new Song(4, "Nonstop","Drake"));
    return songList;
  }
